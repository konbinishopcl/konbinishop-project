...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    address_number: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dates: Schema.Attribute.Component<'event.dates', true>;
    ...
    is_approved: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    is_rejected: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    prices: Schema.Attribute.Component<'event.prices', true>;
    publishedAt: Schema.Attribute.DateTime;
    region: Schema.Attribute.Relation<'manyToOne', 'api::region.region'>;
    rejected_by: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    rejected_reazon: Schema.Attribute.String;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    socialLinks: Schema.Attribute.Component<'event.rrss', true>;
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    videos: Schema.Attribute.Component<'event.videos', true>;
  };
}
...
export interface ApiHeroHero extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hero.hero'> &
      Schema.Attribute.Private;
    mobile_image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    region: Schema.Attribute.Relation<'oneToOne', 'api::region.region'>;
    slug: Schema.Attribute.UID<'title'>;
    tablet_image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    approved: Schema.Attribute.Relation<'manyToOne', 'api::event.event'>;
    ...
    events: Schema.Attribute.Relation<'oneToMany', 'api::event.event'>;
    firstname: Schema.Attribute.String;
    is_company: Schema.Attribute.Boolean;
    lastname: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    rejected: Schema.Attribute.Relation<'oneToMany', 'api::event.event'>;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    role: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.role'
