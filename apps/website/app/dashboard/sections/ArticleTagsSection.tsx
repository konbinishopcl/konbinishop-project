      ...
      <div className="confirm-card" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 480 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: 18 }}>
          <div className="field" style={{ margin: 0 }}>
            ...
            <input type="text" value={data.name || ""} onChange={(e) => set("name", e.target.value)} placeholder="shonen" />
          </div>
          <div className="field" style={{ margin: 0 }}>
            <label>Slug <span style={{ color: "var(--err)" }}>*</span></label>
            <input type="text" value={data.slug || ""} onChange={(e) => set("slug", e.target.value)} placeholder="shonen" />
          </div>
        </div>
