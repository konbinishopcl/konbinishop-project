          ...
          <form onSubmit={submit}>
            ...
            <div className="consent-block">
              <label onClick={() => setAcceptTerms(!acceptTerms)}>
                ...
                <span>Acepto los <Link href="/terminos-y-condiciones" target="_blank">Términos y condiciones</Link> y la <Link href="/politica-de-privacidad" target="_blank">Política de privacidad</Link> de Konbini. <span style={{ color: "var(--err)" }}>*</span></span>
              </label>
